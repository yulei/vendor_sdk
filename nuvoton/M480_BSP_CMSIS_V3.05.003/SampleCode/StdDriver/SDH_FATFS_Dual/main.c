...
void SYS_Init(void)
{
    ...
    /* SDH1 */
    /* select multi-function pin */
    SYS->GPA_MFPL &= ~(SYS_GPA_MFPL_PA6MFP_Msk|SYS_GPA_MFPL_PA5MFP_Msk|SYS_GPA_MFPL_PA4MFP_Msk|SYS_GPA_MFPL_PA3MFP_Msk|
                       SYS_GPA_MFPL_PA2MFP_Msk|SYS_GPA_MFPL_PA1MFP_Msk|SYS_GPA_MFPL_PA0MFP_Msk);
    SYS->GPA_MFPL |= (SYS_GPA_MFPL_PA0MFP_SD1_DAT0|SYS_GPA_MFPL_PA1MFP_SD1_DAT1|SYS_GPA_MFPL_PA2MFP_SD1_DAT2|
                      SYS_GPA_MFPL_PA3MFP_SD1_DAT3|SYS_GPA_MFPL_PA4MFP_SD1_CLK|SYS_GPA_MFPL_PA5MFP_SD1_CMD|SYS_GPA_MFPL_PA6MFP_SD1_nCD);
