...
extern size_t  tmp_len;
extern char  tmp_str[MBEDTLS_ECP_MAX_PT_LEN];

#ifdef NUVOTON_ENABLE_ECC

extern char  tmp_x_str[MBEDTLS_ECP_MAX_PT_LEN];
extern char  tmp_y_str[MBEDTLS_ECP_MAX_PT_LEN];
extern char  tmp_1_str[MBEDTLS_ECP_MAX_PT_LEN];
extern char  tmp_2_str[MBEDTLS_ECP_MAX_PT_LEN];
extern char  tmp_3_str[MBEDTLS_ECP_MAX_PT_LEN];
...
{
    { MBEDTLS_ECP_DP_SECP192R1,  CURVE_P_192  },
    { MBEDTLS_ECP_DP_SECP224R1,  CURVE_P_224  },
    { MBEDTLS_ECP_DP_SECP256R1,  CURVE_P_256  },
    { MBEDTLS_ECP_DP_SECP384R1,  CURVE_P_384  },
    { MBEDTLS_ECP_DP_SECP521R1,  CURVE_P_521  },
    { MBEDTLS_ECP_DP_BP256R1,    CURVE_BP_256 },
    { MBEDTLS_ECP_DP_BP384R1,    CURVE_BP_384 },
    { MBEDTLS_ECP_DP_BP512R1,    CURVE_BP_512 },
//    { MBEDTLS_ECP_DP_CURVE25519, CURVE_UNDEF  },
    { MBEDTLS_ECP_DP_SECP192K1,  CURVE_KO_192 },
    { MBEDTLS_ECP_DP_SECP224K1,  CURVE_KO_224 },
    { MBEDTLS_ECP_DP_SECP256K1,  CURVE_KO_256 },
//    { MBEDTLS_ECP_DP_CURVE448, CURVE_UNDEF  },
};


extern E_ECC_CURVE nuvoton_get_curve(mbedtls_ecp_group_id id);
